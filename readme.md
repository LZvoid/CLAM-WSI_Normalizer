...
基于 [CLAM](https://github.com/mahmoodlab/CLAM)（Clustering-constrained Attention Multiple Instance Learning）的扩展版本，**专为病理切片染色归一化处理而设计**。本项目新增了染色归一化功能，支持端到端的WSI染色归一化特征提取。
